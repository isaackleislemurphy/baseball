...
from baseball.duckdb.database import TABLES, write_parquet, describe_table
from baseball.utils.duckdb import query
from baseball.projects.strategery.constants import MAX_SCORE_DIFFERENTIAL, GAME_STATES
...
result.query("inning == 9 & inning_topbot == 'Bot' & home_lead == -1 & game_state == '12-:2'")

result.query("inning == 1 & inning_topbot == 'Top' & home_lead == -15 & game_state == '12-:2'")
breakpoint()
